...
const Home: NextPage = () => {
  const loginAPI = api.auth.register.useMutation()
    ...
    <>
      ...
      <main className="bg-white">
        <div className="rounded-md border p-4 mx-auto sm:max-w-lg my-32">
                ...
                <p className="text-3xl font-bold mb-3">Daftar</p>
                <hr/>
                <br/>
                <label>Name</label>
                <input value={name} onChange={e => setName(e.target.value)} className="p-3 border rounded-md w-full" placeholder="Erlangga" type="text" required/>
                <label>Email</label>
